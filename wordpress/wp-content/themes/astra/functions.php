...
/**
 * Register a single custom footer widget area used in footer.php
 */
add_action( 'widgets_init', 'astra_register_custom_footer_widget_area' );

function astra_register_custom_footer_widget_area() {
	register_sidebar(
		array(
			'name'          => __( 'Footer Widget 1', 'astra' ),
			'id'            => 'footer-widget-1',
			'description'   => __( 'Add widgets here to appear in the first column of the custom footer.', 'astra' ),
